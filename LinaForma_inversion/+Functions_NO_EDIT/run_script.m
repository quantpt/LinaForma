function run_script(sampleName, model, measurements, dataFormat, keep_cols, unitsP, ...
    ...
    % Plot LOOA
    if plotLOOA == 1
        Functions_NO_EDIT.plotLOOA(dT,dP,variables,tMed,pMed,temperature,pressure)
    end
