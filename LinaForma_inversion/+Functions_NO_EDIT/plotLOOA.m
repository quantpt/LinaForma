function plotLOOA(T_min,T_max,P_min,P_max,variables,T_best,P_best,sampleName)

% Plot T variability
fig10 = figure;
set(fig10,'Units','centimeters')
set(fig10,'Position',[0 0 0.9*21 0.3*29.7])
subplot(1,2,1)
...
% Save figure
name = "FIGURES/L1inv_LOOA_" + sampleName + ".svg";
saveas(fig10,name);
